...
def on_message(client, userdata, msg):
    ...
    if(msg.topic == "team10/camera/apriltagx"):
        global globtagx
        globtagx = payload_to_number(msg.payload)
    elif(msg.topic == "team10/camera/apriltagy"):
        global globtagy
        globtagy = payload_to_number(msg.payload)
    else:
        # SENSOR READOUT
        endStr = "\t"
